...
const Branding = () => {
  return (
    <div className='br-main'>
      ...
      <div className='br-1'>
      <div className='br-inner'>
        <small className='small'>Photography</small>
        <h3 className='br-h3'>The Watch</h3>
      </div>
      <img  className="br-img"src="https://templatemo.com/templates/templatemo_578_first_portfolio/images/projects/the-5th-IQYR7N67dhM-unsplash.jpg"alt=""></img>
      </div>
